...
if(in_array($_SERVER["HTTP_HOST"], $host_aceptados) ){
    ...
    if($_SERVER["REQUEST_METHOD"] == $metodo_aceptado){
        ...
        if (isset($txt_usuario) && !empty($txt_usuario)){
            ...
            if(isset($txt_password) && !empty($txt_password)){
                ...
                $ruta = "";
                $msg = "El campo contrasena esta vacio";
                $codigo_estado = 401;
                $texto_estado = "Unauthorized";
                $token = "";
            }
        ...
        // El metodo usado no es aceptado
        $ruta = "";
        $msg = "El metodo no es el correcto";
        $codigo_estado = 405;
    ...
    $ruta = "";
    $msg = "Su equipo no esta autorizado para realizar la peticion";
    $codigo_estado = 403;
